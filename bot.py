...
def create_app():
    ...
    from conversations import get_agregar_handler, get_reportar_handler, get_registrar_admin_handler, get_reporte_completo_handler
    app.add_handler(get_agregar_handler())
    app.add_handler(get_reportar_handler())
    app.add_handler(get_registrar_admin_handler())
    app.add_handler(get_reporte_completo_handler())
